...
const BlogType2: React.FC<BlogProps> = ({ data }) => {
  ...
  return (
    <div className="bg-gray-50">
      <div className="mx-auto max-w-[1440px] px-6 py-20 lg:p-20">
        ...
        <ul
          role="list"
          className="mx-auto mt-10 grid max-w-screen-xl grid-cols-1 gap-10 xl:grid-cols-2 lg:mx-0 lg:max-w-none"
        >
